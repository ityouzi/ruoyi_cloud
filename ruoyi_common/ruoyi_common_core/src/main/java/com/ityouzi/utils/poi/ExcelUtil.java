...
import com.ityouzi.utils.ToolUtil;
import com.ityouzi.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
     ...
     * @return 结果
     */
    public ResultMsg exportExcel(List<T> list, String sheetName)
    {
     ...
     * @return 结果
     */
    public ResultMsg importTemplateExcel(String sheetName)
    {
